...
const Bar2: React.FC = () => {
  const sources = [
    {
      icon: <Image src="/Ccall.svg" alt="icon" width={24} height={24} />,
      color: "from-green-400 to-green-300",
      height: 70, // Percentage-based height
      value: "70",
    },
    {
      icon: <Image src="/Cmessage.svg" alt="icon" width={24} height={24} />,
      color: "from-blue-400 to-blue-300",
      height: 50,
      value: "50",
    },
    {
      icon: <Image src="/Cfb.svg" alt="icon" width={24} height={24} />,
      color: "from-blue-600 to-blue-400",
      height: 80,
      value: "80",
    },
    {
      icon: <Image src="/Cgmail.svg" alt="icon" width={24} height={24} />,
      color: "from-red-500 to-orange-400",
      height: 90,
      value: "90",
    },
    {
      icon: <Image src="/Cwhatsapp.svg" alt="icon" width={24} height={24} />,
      color: "from-green-500 to-green-400",
      height: 75,
      value: "75",
    },
    {
      icon: <Image src="/Cinsta.svg" alt="icon" width={24} height={24} />,
