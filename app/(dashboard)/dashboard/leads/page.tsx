...
import {  C5Data  } from '../dashboard_data';
...
const Page = () => {
  ...
  const [totalConvertedLeads, setTotalConvertedLeads] = useState<any>();    // eslint-disable-line @typescript-eslint/no-explicit-any
  const [hourlyConvertedLeads, setHourlyConvertedLeads] = useState<any>([]);    // eslint-disable-line @typescript-eslint/no-explicit-any
