...
const Page = () => {
  const [followUpRsns, setFollowUpRsns] = useState<any>([]);    // eslint-disable-line @typescript-eslint/no-explicit-any
  const [totalFollowRsns, setTotalFollowRsns] = useState<any>([]); // eslint-disable-line @typescript-eslint/no-explicit-any
  const [successFollowUps, setSuccessFollowUps] = useState<any>([]); // eslint-disable-line @typescript-eslint/no-explicit-any
