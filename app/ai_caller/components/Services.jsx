...
import { brainwaveServices, brainwaveServicesIcons } from "../components/global/data";
import {
  PhotoChatMessage,
  Gradient,
  VideoBar,
    ...
    <Section id="how-to-use"> 
      <div className="container">
        ...
        <div className="relative w-full  max-w-full overflow-x-hidden">
          <div className="relative z-1 flex items-center h-screen mb-5 p-8 border-0 border-n-1/10 rounded-3xl overflow-hidden xl:h-[46rem]">
            ...
            <div className="relative z-1 ml-auto">
              <h4 className="text-3xl font-bold mb-4 ">Smartest AI</h4>
              ...
              <ul className="body-2">
                {brainwaveServices.map((item, index) => (
                  ...
                  >
                    <img width={20} height={24} src={check} />
                ...
                {/* <ul className="flex items-center justify-between">
                  {brainwaveServicesIcons.map((item, index) => (
                    ...
                    >
                      ...
                      >
                        <img src={item} width={20} height={24} alt={item} />
                      </div>
                    </li>
                  ))}
                </ul> */}
