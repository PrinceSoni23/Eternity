      ...
      <div className="grid md:grid-cols-2 gap-12">
        ...
        <div>
          <p className={`text-base font-semibold mb-4 dark:text-white text-gray-900 ${walsheim_bold.className} flex items-center gap-2`}>
            ...
            <Image src="/info-icon.svg" width={16} height={16} alt="" className="w-4 h-4 cursor-pointer dark:hidden"/>
            <Image src="/info-dark.svg" width={16} height={16} alt="" className="w-4 h-4 cursor-pointer hidden dark:block"/>
