      ...
      >
        ...
        <nav className="mt-4 ml-5 sm:mt-3">
          <ul className="space-y-0 sm:space-y-0">
            {[
              { key: "Company Settings", href: "/Owner_Settings", label: "Company Settings" },
  ...
  <Menu
             ...
             >
               <MenuHandler>
                 ...
                 <IconButton variant="text" placeholder="" onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
                   <Image
                    ...
                    <MenuItem
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        <Typography
                           ...
                           color="gray"
                           placeholder=""
                           className={`text-black dark:text-white ${walsheim_medium.className}`} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
                          {notification.name}
                          {"  "}{" "}
                          <span
                    ...
                    <Link href={"/Owner_Settings"}>
                      ...
                      >
                        ...
                        <span className="text-lg">
                          <Image src="/icons/dd.png" width={16} height={16} alt="" />
                        </span>
                      </button>
                    </Link>
                    <button
