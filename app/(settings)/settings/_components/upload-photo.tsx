    ...
    <ShowcaseSection title="Your Photo" className="!p-7">
      <form>
        <div className="mb-4 flex items-center gap-3">
          ...
          <div>
            ...
            <span className="flex gap-3">
              <button type="button"  className="text-body-sm bg-white hover:text-red">
                Delete
              </button>
              <button className="text-body-sm bg-white hover:text-primary">
                Update
              </button>
            </span>
          </div>
        ...
        <div className="flex justify-end gap-3">
          ...
          <button
            className="flex items-center bg-white border border-stroke justify-center rounded-lg bg-primary px-6 py-[7px] font-medium text-gray-2 hover:bg-opacity-90"
            type="submit"
          >
            Save
          </button>
